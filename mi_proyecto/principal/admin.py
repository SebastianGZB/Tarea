...
class EmpleadoAdmin(admin.ModelAdmin):
    list_display = (
        ...
        'emp_celular', 'emp_foto', 'emp_notas'
    )
...
class OrdenAdmin(admin.ModelAdmin):
    ...
    search_fields = ('id_cliente_cli_nombre', 'id_empleado_emp_nombre')
...
class DetalleOrdenAdmin(admin.ModelAdmin):
    ...
    search_fields = ('orden_id_orden', 'producto_pro_nombre')
...
class CategoriaAdmin(admin.ModelAdmin):
    list_display = ('id_categoria', 'cat_nombre', 'cat_desc', 'cat_foto')
